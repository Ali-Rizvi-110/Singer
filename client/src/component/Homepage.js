...
const Homepage = () => {
  ...
  // Fecth Event Start
  const [ivent, setIvent] = useState([{}]);
  const fetchEvent = async () => {
    try {
      const response = await axios.get(
        "http://localhost:4500/api/admin/showEvents"
      );
      setIvent(response.data);
  ...
  return (
    ...
    <div>
      <div id="main" className="homepage">
        {/* <EventCountdown eventDate="2023-08-11T18:00:00" /> */}
        <motion.div
          className="image1"
          style={{
              ...
              {song?.map((song, index) => (
                ...
                >
                  <div className="d-flex align-items-center">
                    ...
                    >
                      <img
                        src={`http://localhost:4500/api/uploads/${song.thumbnail}`}
                        alt=""
                      />
                    </a>
                    <div>
            ...
            {ivent.map((ivent, index) => (
              ...
              >
                <div className="eventlist" key={index}>
                  <div className="demos">
                    <img
                      src={`http://localhost:4500/api/uploads/${ivent.image}`}
                      alt=""
                    ...
                    <div>
                      ...
                      <div className="row">
                        ...
                        <h6 className="col-2">:</h6>
                        <h6 className="col-7">{ivent.startDate}</h6>
                      </div>
